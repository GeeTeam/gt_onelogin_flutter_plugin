...
class OLUIConfigure{
  ...
  Map<String,dynamic> toMap(){
    return{
      _OLConstant.supportedinterfaceOrientations:supportedinterfaceOrientations,
      _OLConstant.userinterfaceStyle:userinterfaceStyle,
      _OLConstant.isDialogStyle:isDialogStyle,
      _OLConstant.dialogRect : dialogRect,
